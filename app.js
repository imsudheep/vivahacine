document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.reveal-img, .mega-text, .section-title, .philosophy-headline, .philosophy-paragraph, .philosophy-quote, .offering-item, .journey-title, .journey-subtitle, .journey-image-stage, .social-proof-header, .testimonial-slider-container, .explore-content, .instagram-header, .instagram-stats, .instagram-filters, .instagram-grid, .instagram-cta, .final-cta-card, .final-cta-headline, .final-cta-text, .final-cta-btn, .final-cta-scarcity, .pricing-header, .pricing-card, .album-text, .album-form').forEach(el => {
